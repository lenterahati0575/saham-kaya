...
def main():
    ...
    # Snapshot harian "Riwayat Saham" DIHENTIKAN 2026-09-12 (user: "riwayat saham mungkin
    # dihapus saja sejauh ini belum ada mamfaat" - tab-nya di app.py sudah dihapus) - tidak
    # ada gunanya lagi terus menulis ke sheet RIWAYAT_SAHAM yang sudah tidak ditampilkan di
    # manapun. riwayat_journal.py TETAP ada (kode teruji, bukan placeholder palsu) kalau
    # suatu saat mau dipakai lagi.
